...
from .constants import DEFAULT_ACTIVE_COMPETITIONS
...
class Database:
    ...
    async def init(self) -> None:
        ...
        async with aiosqlite.connect(self.path) as db:
            ...
            # Lightweight migrations for databases created by older V1.
        ...
        # V8 migration: if the user was still on Oddium's untouched old default
